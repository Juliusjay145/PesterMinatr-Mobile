...
public class ResidentialBook extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.adapter = new bookresidentialAdapter(this, list);
		...
		try{
			URL url = new URL("http://192.168.43.118/project/index.php/androidcontroller/fetch_commercial/" +id);
	        ...
	        for(int i=0; i<array.length(); i++){
	        	...
	        	String confirm_id = item.getString("commercial_id");
	        	list.add(new bookresidentialList(c_name,c_address,c_date,c_time,c_price,c_status,c_problem,confirm_id,pest));
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		bookresidentialList selectedItem = list.get(arg2);
