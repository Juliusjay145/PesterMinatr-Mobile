...
public class AddFeedbackCommercial extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.add_feedbackcommercial);
	...
	public void onClick(View arg0) {
		...
		String ID = getIntent().getStringExtra("pestcontrol");
		String username = prf.getString("company_name", null);
