...
public class UpdateSchedule extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		//String commercial_price = price.getText().toString();
	    		...
	    		try{
	    			...
	    			HttpPost httpPost = new HttpPost("http://192.168.43.118/project/index.php/androidcontroller/updatereschedresidential/"+id);
