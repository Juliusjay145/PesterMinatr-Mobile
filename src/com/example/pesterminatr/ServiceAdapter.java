...
public class ServiceAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if(arg1==null)
		{
			arg1 = inflater.inflate(R.layout.service_layout, null);
			handler = new ServiceHandler();
			handler.name = (TextView) arg1.findViewById(R.id.servicename);
			handler.price = (TextView) arg1.findViewById(R.id.serviceprice);
			handler.image = (ImageView) arg1.findViewById(R.id.service_logo);
			arg1.setTag(handler);
		}else
