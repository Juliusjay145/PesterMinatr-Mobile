...
public class UpdateBookingDetails extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String id = getIntent().getStringExtra("client_residential_id");
		//Toast.makeText(getApplicationContext(), id, Toast.LENGTH_SHORT).show();
		
		
		try{
			URL url = new URL("http://192.168.43.118/project/index.php/androidcontroller/fetch_selected_client_details/"+id);
	        ...
	        for(int i=0; i<array.length(); i++){
	        	...
	        	String cd = item.getString("residential_address");
	        	String cc = item.getString("date");
	        	String ct = item.getString("time");
	        	String r_price = item.getString("price");
//	        	Toast.makeText(getApplicationContext(), cn, Toast.LENGTH_LONG).show();
	        	...
	        	//squaremeter.setTextAlignment(textAlignment);
	        }
	...
	public void onClick(View arg0) {
		...
		String commercial_meter = squaremeter.getSelectedItem().toString();
	    		...
	    		try{
	    			...
	    			HttpPost httpPost = new HttpPost("http://192.168.43.118/project/index.php/androidcontroller/updateDetailsResidential/"+id);
