...
public class residentialupdatedetails extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		if(arg0==btnUpdate)
		{
			...
			String res_time = rtime.getText().toString();
		    		...
		    		try{
		    			...
		    			HttpPost httpPost = new HttpPost("http://192.168.43.118/project/index.php/androidcontroller/updateDetails/"+id);
		...
		if(arg0==btnCancel)
		{
			...
			String res_time = rtime.getText().toString();
		    		...
		    		try{
		    			HttpClient httpClient = new DefaultHttpClient();
		    			HttpPost httpPost = new HttpPost("http://192.168.43.118/project/index.php/androidcontroller/updateCancelDetails/"+id);
		    			httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
		    			HttpResponse response = httpClient.execute(httpPost);
		    			HttpEntity entity = response.getEntity();
		    			InputStream is;
